...
(function ($) {
    ...
    $('#stream1').append(`
        <div class="player-wpr">
            <div class="bg-wpr bg-grey accent-deeporange">
                                ...
                                <ul class="socials">
                                    <li class="afacebook">
                                        <a target="_blank" href="#">
                                            <i class="fab fa-facebook facebook" style=""></i>
                                            Facebook
                                        </a>
                                    </li>
                                    <li class="atwitter">
                                        <a target="_blank" href="#">
                                            <i class="fab fa-twitter twitter" style=""></i>
                                            Twitter
                                        </a>
                                    </li>
                                </ul>
                ...
                <div class="player-ctr">
                    ...
                    <div class="track-info animated">
                        <div class="track-title animated"> Espacio Team </div>
                        <div class="artist-name animated"></div>
                    </div>
                    <div class="controls-wpr animated">
                        <div class="vol-icon fa vol-icon2"></div>
                        <div class="volume-slider-wpr">
                            <input placeholder="vol" class="volume-slider" type="range" min="0" max="100" step="0.10"
                                value="" autocomplete="off">
                            <span class="vol-value">23%</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    $.fn.myCast = function (options) {
        var settings = $.extend({
            ...
            logo: "https://espacioteam.com/assets/img/cover/espacio_team.png",
        ...
        function GPShareLink(siteURL) {
            ...
            $("li.ainstagram", thisObj).find("a").attr("href", url);
        }
